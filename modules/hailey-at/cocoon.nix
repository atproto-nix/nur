    ...
    serviceConfig = {
      ...
      script = ''
        ...
        if [ ! -f "${cfg.rotationKeyPath}" ]; then
          ...
          PYTHONPATH=${pkgs.python312Packages.pyjwkest}/lib/python3.12/site-packages:${pkgs.python312Packages.six}/lib/python3.12/site-packages:${pkgs.python312Packages.pycryptodomex}/lib/python3.12/site-packages:${pkgs.python312Packages.requests}/lib/python3.12/site-packages:${pkgs.python312Packages.urllib3}/lib/python3.12/site-packages:${pkgs.python312Packages.future}/lib/python3.12/site-packages ${pkgs.python312Packages.python}/bin/python -c '
import sys
